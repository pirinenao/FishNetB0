...
2.  **Phase 2 (Fine-Tuning):** The entire model was un-frozen and fine-tuned with a very low learning rate (`1e-5`) to adapt the features.
...
>**_NOTE:_**  Trained with TensorFlow 2.20.0 and **Keras 2** with legacy optimizer due to apple silicone compatibility issues with newer optimizers.
